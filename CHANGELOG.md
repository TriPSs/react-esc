...
* **react-esc:** Enabled rollup again so newer syntax can be used in the configs ([3cc1fe5](https://github.com/TriPSs/react-esc/commit/3cc1fe5))
...
* **webpack-image:** Added webpack-image package ([7ca20eb](https://github.com/TriPSs/react-esc/commit/7ca20eb))
